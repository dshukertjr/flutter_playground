...
Deno.serve(async (req) => {
  ...
  const input = `In the heart of a bustling city, there stood a quaint bookstore with creaky wooden floors and shelves stacked high with stories waiting to be discovered. It was run by an elderly gentleman named Mr. Emerson, whose love for books was surpassed only by his love for sharing them.
